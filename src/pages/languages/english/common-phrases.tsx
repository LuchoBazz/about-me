              ...
              <div className="relative flex-grow md:flex-grow-0 md:w-80">
                ...
                <input
                  ...
                  className={`block w-full pl-10 pr-3 py-2 border rounded-lg leading-5 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-150 ease-in-out
                    ${isDarkMode 
                      ? 'bg-slate-700 border-slate-600 text-white placeholder-slate-400 focus:bg-slate-700 focus:border-indigo-500' 
              ...
              <button
                ...
                className={`p-2 rounded-lg border transition-all duration-200 flex-shrink-0
                  ${isDarkMode 
                    ...
                    : 'bg-white border-slate-300 text-slate-600 hover:bg-slate-50 hover:text-indigo-600'
                  }`}
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      <button
                        ...
                        className={`p-2 rounded-full border shadow-sm transition-all duration-200
                          ${isDarkMode
                            ? 'bg-slate-700 border-slate-600 text-slate-400 hover:text-indigo-300 hover:bg-slate-600'
                      ...
                      <button
                        ...
                        className={`p-2 rounded-full transition-all duration-200 border shadow-sm
                          ${copiedIndex === index 
                            ? (isDarkMode ? 'bg-green-900/30 text-green-400 border-green-800' : 'bg-green-100 text-green-600 border-green-200') + ' scale-110' 
                            : (isDarkMode ? 'bg-slate-700 border-slate-600 text-slate-400 hover:text-indigo-300 hover:bg-slate-600' : 'bg-white text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 border-slate-200')
                          }
                        `}
                        title="Copiar frase"
                      >
                      ...
                      <button
                        ...
                        className={`p-1 rounded-full transition-colors flex-shrink-0
                          ${isDarkMode 
                            ...
                            : 'text-indigo-400 hover:text-indigo-600 hover:bg-indigo-200'
                          }`}
